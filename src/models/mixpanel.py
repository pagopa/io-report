...
users_reports = [{"description": "# installazioni avvenute nel periodo (fonte Mixpanel)", "id": 13850641},
				 {"description": "% login avvenuti con successo con SPID", "id": 13850659},
				 {"description": "% login avvenuti con successo con CIE", "id": 15507536},
...
payments_reports = [{"description": "% utenti che abbandonano un pagamento allo step finale", "id": 26999381,
					...
					{"description": "% pagamenti che hanno successo allo step finale", "id": 27707760,
					 "extractor": mp_extract("successo/all")},
...
# paypal
paypal_reports = [{"description": "% di successo in fase di checkout aggiunta Paypal", "id": 27301649},
